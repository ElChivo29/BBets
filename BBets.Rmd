...
print(money)
```
the number of students to regualry make the pay out would be 29 students.
...
in conclusion you would have to change the number of students or the payout in order to make some profit.
